...
alias cl='cd $HOME/code/commonlit'
...
alias gaa='git add -p'
alias gac='ga . && gcom'
alias gb='git branch -vv --color | rg -v "z-" | git-branch-list-whitespace-reducer'
...
alias grim='git rebase -i origin/$(main-branch)'
...
alias yw='rm -rf public/builds/ && yarn watch'
