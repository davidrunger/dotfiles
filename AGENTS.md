...
- After implementing a requested change, commit the completed work on its task branch before handing it back, unless the user specifically asks not to commit. This makes review feedback easy to compare as follow-up commits in the Git reflog.
