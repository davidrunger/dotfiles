...
ln -sf ~/code/dotfiles/initializers/z.rb ~/code/commonlit/config/initializers/z.rb
ln -sf ~/code/dotfiles/irbrc.rb ~/.irbrc.rb
ln -sf ~/code/dotfiles/pryrc.rb ~/.pryrc
ln -sf ~/code/dotfiles/qr.rb ~/code/commonlit/personal/qr.rb
ln -sf ~/code/dotfiles/rspec ~/.rspec
ln -sf ~/code/dotfiles/rubocop.yml ~/.rubocop.yml
ln -sf ~/code/dotfiles/workers/load_runner.rb ~/code/commonlit/app/workers/load_runner.rb
